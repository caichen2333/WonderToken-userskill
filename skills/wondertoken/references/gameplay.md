...
- The first free trip advances at 10 real seconds per virtual day; each later journey created under the current rules advances at one real minute per virtual day. A journey freezes its clock at departure, and legacy journeys without a clock snapshot retain the former 10-second pace. The default first route ends after 100 real seconds (day 10); later journeys reach the day-28 cap after 28 minutes; homecoming still happens through the existing progress-query flow. Preserve fractional virtual days.
